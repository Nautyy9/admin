      ...
      >
        ...
        <div>
          ...
          <ul className="mt-3">
            ...
            {/* Shelves */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'shelves' && 'bg-gray-900'}`}>
              <NavLink exact to="/shelves" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'shelves' && 'hover:text-gray-200'}`}>
                <div className="flex items-center justify-between">
                  <div className="flex flex-grow">
                    <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                      <path className={`fill-current text-gray-400 ${page === 'shelves' && 'text-indigo-300'}`} d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z" />
                      <path className={`fill-current text-gray-700 ${page === 'shelves' && 'text-indigo-600'}`} d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z" />
                      <path className={`fill-current text-gray-600 ${page === 'shelves' && 'text-indigo-500'}`} d="M13 15.047V24l10.573-7.181A.999.999 0 0024 16V8l-11 7.047z" />
                    </svg>
            ...
            {/* Tasks */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'entryexit' && 'bg-gray-900'}`}>
              <NavLink exact to="/entryexit" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'entryexit' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
                    <path className={`fill-current text-gray-600 ${page === 'entryexit' && 'text-indigo-500'}`} d="M8 1v2H3v19h18V3h-5V1h7v23H1V1z" />
                    <path className={`fill-current text-gray-600 ${page === 'entryexit' && 'text-indigo-500'}`} d="M1 1h22v23H1z" />
                    <path className={`fill-current text-gray-400 ${page === 'entryexit' && 'text-indigo-300'}`} d="M15 10.586L16.414 12 11 17.414 7.586 14 9 12.586l2 2zM5 0h14v4H5z" />
                  </svg>
            ...
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page.startsWith('team') && 'bg-gray-900'}`}>
              ...
              <ul className={`pl-9 mt-1 ${!page.startsWith('team-') && 'hidden'}`}>
                <li className="mb-1 last:mb-0">
                  <NavLink exact to="/" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'team-list' && 'text-indigo-400 hover:text-indigo-400'}`}>
                    <span className="text-sm font-medium">Team List</span>
                  </NavLink>
                </li>
                <li className="mb-1 last:mb-0">
                  <NavLink exact to="/" className={`block text-gray-200 hover:text-white transition duration-150" ${page === 'team-add' && 'text-indigo-400 hover:text-indigo-400'}`}>
